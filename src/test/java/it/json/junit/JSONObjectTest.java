...
import it.json.XML;
import it.json.junit.data.BrokenToString;
import it.json.junit.data.ExceptionalBean;
import it.json.junit.data.Fraction;
import it.json.junit.data.GenericBean;
import it.json.junit.data.GenericBeanInt;
import it.json.junit.data.MyBean;
import it.json.junit.data.MyBeanCustomName;
import it.json.junit.data.MyBeanCustomNameSubClass;
import it.json.junit.data.MyBigNumberBean;
import it.json.junit.data.MyEnum;
import it.json.junit.data.MyEnumField;
import it.json.junit.data.MyJsonString;
import it.json.junit.data.MyNumber;
import it.json.junit.data.MyNumberContainer;
import it.json.junit.data.MyPublicClass;
import it.json.junit.data.RecursiveBean;
import it.json.junit.data.RecursiveBeanEquals;
import it.json.junit.data.Singleton;
import it.json.junit.data.SingletonEnum;
import it.json.junit.data.WeirdList;
import org.junit.Test;
import it.json.junit.Util;
...
public class JSONObjectTest {
    ...
    public void jsonObjectByResourceBundle() {
        JSONObject jsonObject = new
                JSONObject("it.json.junit.data.StringsResourceBundle",
                        Locale.getDefault());
...
//        assertTrue("should convert null to empty string", "".equals(string));
    ...
    */
    ...
    public void jsonObjectClearMethodTest() {
        ...
        jsonObject.getInt("key1"); //Should throws it.json.JSONException: JSONObject["asd"] not found
        Util.checkJSONObjectMaps(jsonObject);
    }
